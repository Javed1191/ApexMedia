...
public class JobDetailProposalActivity extends AppCompatActivity
{
...
//        toolbar.setLogo(R.drawable.actionbar_32);
        ...
        final JobDetailsProposalTabAdapter adapter = new JobDetailsProposalTabAdapter(fm, tabLayout.getTabCount(),jobId,porposal_id);
