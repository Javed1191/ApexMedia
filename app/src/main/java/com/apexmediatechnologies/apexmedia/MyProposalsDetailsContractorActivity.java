...
public class MyProposalsDetailsContractorActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_contractor_myproposals_detail);
        ...
        final MyProposalContractorTabAdapter adapter = new MyProposalContractorTabAdapter(fm, tabLayout.getTabCount(),jobId,porposal_id);
