...
public class FragmentEmployerDashboard extends Fragment
{


	View view;
	LinearLayout lay_post_jobs,lay_my_jobs,lay_profile,lay_payments,lay_setting,lay_faqs,lay_contact_support,lay_message;
	private Utility utility;
	private String is_tax="no",is_psychometric="no";
	private EmployerMainActivity context;

	public FragmentEmployerDashboard()
	{
	}
			...
			Bundle savedInstanceState)
	{
		...
		view=inflater.inflate(R.layout.fragment_employer_dashboard,container, false);
		...
		lay_post_jobs = (LinearLayout) view.findViewById(R.id.lay_post_jobs);
		lay_my_jobs = (LinearLayout) view.findViewById(R.id.lay_my_jobs);
		...
		if(is_psychometric.equalsIgnoreCase("no"))
		{
			...
			tv_confirm.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					try {
						...
						intent.putExtra("is_employer",true);
...
*/
		...
		lay_my_jobs.setOnClickListener(new View.OnClickListener()
		{
			@Override
			public void onClick(View v)
			{
