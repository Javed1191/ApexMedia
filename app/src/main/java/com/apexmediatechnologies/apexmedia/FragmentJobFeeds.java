...
public class FragmentJobFeeds extends Fragment
{
	View view;
	private RecyclerView feed_recycler_view;
	private TextView tv_feeds_not_found;
	private JobFeedsAdapter feedsAdapter;
	private Toolbar toolbar;
	private Utility utility;
	private String strGetfeeds = Application_Constants.Main_URL+"keyword=jobs";
			...
			Bundle savedInstanceState)
	{
		...
		view=inflater.inflate(R.layout.fragment_job_feeds,container, false);
				...
				btn_submit.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v)
					{
						...
						if(filterSubCatList!=null)
						{
							...
							sub_cat = android.text.TextUtils.join(",", list_sub_cat);
						}
