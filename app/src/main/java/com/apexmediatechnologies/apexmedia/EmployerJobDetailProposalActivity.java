...
public class EmployerJobDetailProposalActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // toolbar.setLogo(R.drawable.actionbar_32);
        ...
        final EmployerJobDetailsProposalTabAdapter adapter = new EmployerJobDetailsProposalTabAdapter(fm, tabLayout.getTabCount(),jobId);
