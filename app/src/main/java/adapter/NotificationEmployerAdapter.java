...
public class NotificationEmployerAdapter extends RecyclerView.Adapter<NotificationEmployerAdapter.CustomViewHolder> {
    ...
    public NotificationEmployerAdapter(Context context, List<Notification> feedList)
    {
       ...
       customViewHolder.tv_title.setText(notification.getTitle());
        ...
        customViewHolder.lay_view_milstones.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if(str_screen.equalsIgnoreCase("proposal_detail"))
                {
                    Intent intent = new Intent(mContext, MyJobProposalDetailActivity.class);
                    intent.putExtra("porposal_id",notification.getProposal_id());
