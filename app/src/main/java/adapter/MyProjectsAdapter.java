...
public class MyProjectsAdapter extends RecyclerView.Adapter<MyProjectsAdapter.CustomViewHolder> {
    ...
    public MyProjectsAdapter(Context context, List<JobFeeds> feedList)
    {
       ...
       customViewHolder.tv_job_title.setText(jobFeeds.getJob_title());
        ...
        customViewHolder.lay_job_feed.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mainActivity, JobDetailActivity.class);
                intent.putExtra("jobProgress",jobFeeds.getJobProgress());
                intent.putExtra("jobId",jobFeeds.getJobId());
                intent.putExtra("jobTitle",jobFeeds.getJob_title());
                intent.putExtra("jobDec",jobFeeds.getJob_description());
                intent.putExtra("jobSkills",jobFeeds.getJob_skills());
                intent.putExtra("jobStartType",jobFeeds.getStart_type());
                intent.putExtra("jobPostedDate",jobFeeds.getSchedule_date());
                intent.putExtra("jobBudget",jobFeeds.getJob_budget());
                intent.putExtra("userName",jobFeeds.getPosted_user_firt_name()+""+jobFeeds.getPosted_user_last_name());
                intent.putExtra("userCountry",jobFeeds.getUser_country_name());
                intent.putExtra("userImage",jobFeeds.getUser_image());
                intent.putExtra("empId",jobFeeds.getEmpId());
